...
from src.earl.baselines.cf.algorithms.star_gan.logger import Logger
from src.earl.baselines.cf.algorithms.star_gan.model import Generator, Discriminator
    ...
    def train(self):
        ...
        for i in range(self.num_iters):
            ...
            if (i+1) % 10 == 0:
                ...
                log = "Elapsed [{}], Epoch [{}/{}]".format(et, i+1, self.num_iters)
